...
var fuelBox = document.forms[0].fuel;
...
function createRecommendation() {
  console.log("createRecommendation() has run");
  if (acresBox.value <= 5000) { // 5000 acres or less, no crop test needed
    console.log("5000 acres or less, no crop test needed");
    if (monthsBox.value >= 10) { // 10+ months of farming per year
      console.log("10+ months of farming per year");
      ...
      console.log("9 or fewer months per year");
    ...
    console.log("more than 5000 acres");
    if (monthsBox.value <= 9) { // 9 or fewer months per year, no crop test needed
      console.log("9 or fewer months per year, no crop test needed");
